...
#Setting up "Menu"
@main_dishes = [Dish.new('Cheeseburger', 5.99), Dish.new("Chicken Sandwich", 5.99), Dish.new("Fried Chicken", 6.99), Dish.new("Fish Sticks", 4.99)]
@side_dishes = [Dish.new('French Fries', 1.99), Dish.new("Mac and Cheese", 2.49), Dish.new("Onion Rings", 2.99)  ]
@basket = []
# p @main_dishes
# p @side_dishes
# p @main_dishes.class
...
def in_basket
    ...
    @basket.each do |basket|
        puts "#{basket[:name]}      Price: #{basket[:price]}"
    end
end
